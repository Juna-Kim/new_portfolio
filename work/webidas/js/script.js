$(document).ready(function(){
  ...
  var swiperTopNum = $('.swiper_bg').find('.swiper-slide');
  var swiperSubNum = $('.swiper_cont').find('.swiper-slide');

  var galleryTop = new Swiper('.swiper_bg', {    
  ...
  var galleryThumbs = new Swiper('.swiper_cont', {
